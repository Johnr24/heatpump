...
for system in systems:
    ...
    if system['stats']['combined_cop'] != None:
        ...
        flowT_when_running = "%.1f" % system['stats']['running_flowT_mean'] if system['stats'] and system['stats']['running_flowT_mean'] is not None else "N/A"
        outsideT_when_running = "%.1f" % system['stats']['running_outsideT_mean'] if system['stats'] and system['stats']['running_outsideT_mean'] is not None else "N/A"
